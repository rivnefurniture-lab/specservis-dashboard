...
- **Fix:** дати нормалізуються незалежно від runtime-типу; Excel збирається стабільними порціями по 200 рядків паралельно, а довідники та службові зведення читаються лише для першої порції.
