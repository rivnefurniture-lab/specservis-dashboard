...
- **Fix:** Excel збирається стабільними порціями по 200 рядків; довідники та службові зведення читаються лише для першої порції, тому наступні сторінки не повторюють зайві запити.
